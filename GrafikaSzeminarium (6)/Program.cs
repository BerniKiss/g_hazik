...
namespace GrafikaSzeminarium
{
    internal class Program
    {
        ...
        private static Vector3 frontFaceColor = new Vector3(1f, 0f, 0f);
        private static Vector3[] colors = new Vector3[]
        {
            new Vector3(1f, 0.4f, 0.7f),    // rozsaszin
            new Vector3(0.5f, 0f, 0.5f),    // lila
            new Vector3(1f, 0.5f, 0f),  // narancs
        ...
        private static string GetEmbeddedResourceAsString(string resourceRelativePath)
        {
            ...
            // new UTF8Encoding(false) helyett detectEncodingFromByteOrderMarks true nem ment maskepp
            using (var resStreamReader = new System.IO.StreamReader(resStream, System.Text.Encoding.UTF8, detectEncodingFromByteOrderMarks: true))
            {
        ...
        private static unsafe void GraphicWindow_Render(double deltaTime)
        {
            ...
            ImGuiNET.ImGui.SeparatorText("Illuminációs komponensek");

            ImGuiNET.ImGui.Text("Ambient Strength (R/G/B)");
            ImGuiNET.ImGui.SliderFloat("Ambient R", ref ambientStrength.X, 0f, 1f);
            ImGuiNET.ImGui.SliderFloat("Ambient G", ref ambientStrength.Y, 0f, 1f);
            ImGuiNET.ImGui.SliderFloat("Ambient B", ref ambientStrength.Z, 0f, 1f);

            ImGuiNET.ImGui.Spacing();
            ImGuiNET.ImGui.Text("Diffuse Strength (R/G/B)");
            ImGuiNET.ImGui.SliderFloat("Diffuse R", ref diffuseStrength.X, 0f, 1f);
            ImGuiNET.ImGui.SliderFloat("Diffuse G", ref diffuseStrength.Y, 0f, 1f);
            ImGuiNET.ImGui.SliderFloat("Diffuse B", ref diffuseStrength.Z, 0f, 1f);

            ImGuiNET.ImGui.Spacing();
            ImGuiNET.ImGui.Text("Specular Strength (R/G/B)");
            ImGuiNET.ImGui.SliderFloat("Specular R", ref specularStrength.X, 0f, 1f);
            ImGuiNET.ImGui.SliderFloat("Specular G", ref specularStrength.Y, 0f, 1f);
            ImGuiNET.ImGui.SliderFloat("Specular B", ref specularStrength.Z, 0f, 1f);

            ImGuiNET.ImGui.SeparatorText("Háttérfény (Light Color)");
            ...
            // ✅ Színválasztó kontrol (ColorEdit3)
            ImGuiNET.ImGui.SeparatorText("Kocka előlapjának színe");
            ImGuiNET.ImGui.ColorEdit3("Front Face Color", ref frontFaceColor);
